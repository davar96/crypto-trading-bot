...
## Lessons Learned (Worth the 100 Hours)

1. **Technical Analysis is astrology for men with spreadsheets**
2. **If a strategy worked, it wouldn't be on YouTube**
3. **Backtests lie, even when done correctly**
4. **The house always wins (be the exchange, not the trader)**
...
| Strategy      | Annual Return | Sharpe  | Max DD  | Verdict           |
| ------------- | ------------- | ------- | ------- | ----------------- |
| Momentum      | 0.75%         | 0.12    | 43%     | Complete Failure  |
| Pairs Trading | 5.66%         | 0.89    | 4.2%    | Too Rare          |
| Funding Arb   | 4-6%          | 0.6-0.8 | <1%     | No Opportunity    |
| Simple Trend  | 7.6%          | 0.82    | 4.78%   | Not Worth It      |
| Multi-Frame   | 3.6%          | 0.09    | 28.79%  | Disaster          |
| **S&P 500**   | **12%**       | **1.0** | **20%** | **Just Buy This** |
...
**100 hours of work. 5 strategies. 0 profits.**
...
> _"The market can remain irrational longer than you can remain solvent."_ - Keynes

> _"But more importantly, the market can remain efficient longer than you can find an edge."_ - Me, after 100 hours
